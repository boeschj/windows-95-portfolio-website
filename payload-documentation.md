...
Basics
Getting Started
What is Payload?ConceptsInstallation
Configuration
Database
Fields
Access Control
...
Note: New Database Adapters are becoming available every day. Check the docs for the most up-to-date list of what's available.
...
You may need to copy all of your existing frontend files, including your existing root layout, into its own newly created Route Group, i.e. (my-app).
...
Set your own project to use ESM, by adding "type": "module" to your package.json file
Give your Next.js config the .mjs file extension
