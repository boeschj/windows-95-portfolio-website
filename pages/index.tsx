...
const Home: NextPage = (): JSX.Element => {
  ...
  const Footer: React.FC = () => {
    ...
    return (
      <div className='h-[35px] flex items-center justify-between'>
        <GradientWrapper style="h-8 w-24 text-center items-center flex" gradientBorders={showNavMenu ? buttonClickedBorders : modalGradientBorders} >
        ...
        <GradientWrapper style="w-auto h-8" gradientBorders={timeGradientBorders}  >
          <Clock />
        </GradientWrapper>
      </div>
    )
      ...
      <div className="bg-windows-gray mx-auto h-fit md:h-[824px] w-full">
        ...
        <div className="flex flex-col p-5">
          <div className="flex flex-row">
            <GradientWrapper style={`bg-windows-gray h-[35px] w-[100px] ${tabSelected === 0 ? 'mt-0' : 'mt-[3px]'}`} gradientBorders={tabGradientBorders} children={
              <button className={'bg-windows-gray h-[30px] w-full'} onClick={() => setTabSelected(0)}>
                About Me
              </button>
            } />
            <GradientWrapper style={`bg-windows-gray h-[35px] w-[100px] ${tabSelected === 1 ? 'mt-0' : 'mt-[3px]'}`} gradientBorders={tabGradientBorders} children={
              <button className={'bg-windows-gray h-[30px] w-full'} onClick={() => setTabSelected(1)}>
                Experience
              </button>
            } />
            <GradientWrapper style={`bg-windows-gray h-[35px] w-[100px] ${tabSelected === 2 ? 'mt-0' : 'mt-[3px]'}`} gradientBorders={tabGradientBorders} children={
              <button className={'bg-windows-gray h-[30px] w-full'} onClick={() => setTabSelected(2)}>
                Skills
              </button>
            } />
          </div>
          <GradientWrapper style={'w-full'} gradientBorders={modalGradientBorders} children={
            <div>
              <div className="flex flex-row">
          ...
          <div className="flex flex-row space-x-5 pt-5 justify-end">
            <GradientWrapper gradientBorders={buttonClicked.github ? buttonClickedBorders : modalGradientBorders} children={
              <button
                onClick={() => {
                  setButtonClicked({
                    ...buttonClicked,
            ...
            <GradientWrapper gradientBorders={buttonClicked.linkedIn ? buttonClickedBorders : modalGradientBorders} children={
              <button
                onClick={() => {
                  setButtonClicked({
                    ...buttonClicked,
            ...
            <GradientWrapper style="hidden md:flex" gradientBorders={buttonClicked.resume ? buttonClickedBorders : modalGradientBorders} children={
  ...
  return (
    <div className="flex bg-windows-bg min-h-screen w-full flex-col justify-between content-center">
      ...
      <GradientWrapper style='mx-auto w-full bg-windows-gray content-center' children={<div className='h-[35px] flex items-center justify-between'>
        <GradientWrapper style="h-8 w-24 text-center items-center flex" gradientBorders={showNavMenu ? buttonClickedBorders : modalGradientBorders} children={
          <button
        ...
        <GradientWrapper style="w-auto h-8" gradientBorders={timeGradientBorders} children={
          < Clock />
        } />
